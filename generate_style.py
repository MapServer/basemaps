...
styles = {
    ...
    'bw': {
        'trunk_ol_clr': '"#000000"',
        'trunk_clr': '"#FFFFFF"',
        'trunk_centerline_clr': '"#FFFFFF"',
        'trunk_bridge_clr': '"#000000"',
        'motorway_lbl_clr': '"#000000"',
        'motorway_ol_clr': '"#000000"',
        'motorway_clr': '"#FFFFFF"',
        'motorway_centerline_clr': '"#FFFFFF"',
        'motorway_bridge_clr': '"#000000"',
        'primary_ol_clr': '"#000000"',
        'primary_clr': '"#FFFFFF"',
        'primary_bridge_clr': '"#000000"',
        'secondary_ol_clr': '"#000000"',   
        'secondary_clr': '"#FFFFFF"',
        'secondary_bridge_clr': '"#000000"',
        'tertiary_ol_clr': '"#000000"',   
        'tertiary_clr': '"#FFFFFF"',
        'tertiary_bridge_clr': '"#000000"',
        'other_ol_clr': '"#000000"',
        'other_clr': '"#FFFFFF"',
        'other_bridge_clr': '"#000000"',
        'pedestrian_ol_clr': '"#000000"',
        'pedestrian_clr': '"#FFFFFF"',
        'pedestrian_bridge_clr': '"#000000"',
        'footway_ol_clr': '"#FFFFFF"',
        'footway_clr': '"#000000"',
        # 'footway_bridge_clr': '"#000000"',
        'track_ol_clr': '"#FFFFFF"',
        'track_clr': '"#000000"',      
        'cycleway_ol_clr': '"#FFFFFF"',
        'cycleway_clr': '"#000000"',
        # 'cycleway_bridge_clr': '"#000000"',
        # 'railway_ol_clr': '"#000000"',
        'railway_clr': '"#000000"',
        'taxiway_clr': '"#000000"',
        'runway_ol_clr': '"#FFFFFF"',
        'runway_clr': '"#000000"',
        'runway_center_clr': '"#FFFFFF"',
        ...
        'ocean_clr': '"#FFFFFF"',
        'ocean_lbl_clr': '"#000000"',
 
        'park_olclr': '"#000000"',
        'park_clr': '"#FFFFFF"',
        'land_ol_clr': '"#000000"',
        'land_clr': '"#FFFFFF"',
        'forest_ol_clr': '"#000000"',
        'forest_clr': '"#FFFFFF"',

        'village_ol_clr': '"#000000"',
        'village_clr': '"#FFFFFF"',
        'town_ol_clr': '"#000000"',
        'town_clr': '"#FFFFFF"',
        'suburb_ol_clr': '"#000000"',
        'suburb_clr': '"#FFFFFF"',
        'city_ol_clr': '"#000000"',
        'city_clr': '"#FFFFFF"',

        'building_ol_clr': '"#FFFFFF"',
        'building_clr': '"#000000"',
        'building_opacity': 100,
        'display_buildings': 1,

        'hospital_ol_clr': '"#000000"',
        'hospital_clr': '"#FFFFFF"',

        'residential_ol_clr': '"#000000"',
        'residential_clr': '"#FFFFFF"',       
        'cemetery_ol_clr': '"#000000"',
        'cemetery_clr': '"#FFFFFF"',
        'sports_ol_clr': '"#000000"',
        'sports_clr': '"#FFFFFF"',
        'education_ol_clr': '"#000000"',
        'education_clr': '"#FFFFFF"',
        'industrial_ol_clr': '"#000000"',
        'industrial_clr': '"#FFFFFF"',
        'transport_ol_clr': '"#000000"',
        'transport_clr': '"#FFFFFF"',

        'border_2_inner_clr': '"#000000"',
        'border_2_clr': '"#000000"'
  
        # 'locality_ol_clr': '"#000000"',
        # 'locality_clr': '"#FFFFFF"',
        # 'hamlet_ol_clr': '"#000000"',
        # 'hamlet_clr': '"#FFFFFF"',
        # 'capital_fg_clr': '"#000000"',
        # 'capital_ol_clr': '"#000000"',
        # 'capital_clr': '"#FFFFFF"'
...
parser.add_option("-b", "--include-base",
                  action="store", dest="include_base",
                  help="""include custom Mapfile snippet as background map
                  (between lines and landuse)""")
parser.add_option("-o", "--include-overlay",
                  action="store", dest="include_overlay",
                  help="""include custom Mapfile snippet as overlay map
                  (on top of anything else for all the scales)""")

(options, args) = parser.parse_args()

items = list(vars.items())
for namedstyle in style_aliases[options.style].split(','):
    items = items + list(styles[namedstyle].items())
...
if options.include_base and os.path.isfile(options.include_base):
    print('#define _include_base \'{}\''.format(options.include_base))
