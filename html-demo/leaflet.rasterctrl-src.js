...
L.Control.RasterCtrl = L.Control.extend({
    ...
    htmlLayout: "<div id='serverdiv'><b>GDAL</b><form id='form1' method='get'>interpolation method: <select id='selmethod' name='method'>" +
    ...
    "Radius: <input type='number' name='radius' min='-1' max='10000' step='2' value='0'><br/>" +
    ...
    "<input type='submit' value='regenerate'/></form></div>",
