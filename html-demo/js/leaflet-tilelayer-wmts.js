L.TileLayer.WMTS = L.TileLayer.extend({
    ...
    initialize: function (e, t) {
        this._url = e;
        var n = L.extend({}, this.defaultWmtsParams), r = t.tileSize || this.options.tileSize;
    ...
    getTileUrl: function (e, t) {
        ...
        console.log('map zoom: ' + e.z + ' ident: ' + ident)
        // TODO: nico ribot hack: bad ident after zoom => force use z value given by leaflet
        ident = e.z
