...
OSM_SRID=3857
OSM_UNITS=meters
OSM_DB_CONNECTION=host=localhost dbname=osm user=nicolas password=osm port=5436
#OSM_EXTENT=-20000000 -20000000 20000000 20000000
OSM_EXTENT=-36387 5247099 384161 5628555
...
includes=land.map landusage.map borders.map highways.map places.map symbols-aeroways.map symbols-amenities-pt.map symbols-amenities-pg.map symbols-stations.map \
